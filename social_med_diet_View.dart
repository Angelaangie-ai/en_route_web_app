                                  ...
                                  Padding(
                                    ...
                                    child: CustomPaint(
                                      painter: CurvePainter(
                                          colors: [
                                            LightColors.kMyFavGreen,
                                            LightColors.kLighterGreen,
                            ...
                            onPressed: () {
                              showDialog(context: context,
                                builder: (_) => CupertinoAlertDialog(
                                  title:Text("Here you would be able to check the live scoreboard.",style: TextStyle(fontFamily: "Bryndan"),),
                                ),
                              );
                            },
                          ),
