...
import 'package:enroute/components/style.dart' as prefix0;
    ...
    if (!form.validate()) {
      ...
      _scaffoldKey.currentState.showSnackBar(
          SnackBar(
            ...
            content: Text('Activity details updated successfully!'),
    ...
    Column(
      ...
      children: <Widget>[
        ListTile(
          ...
          subtitle: Column(
            children: <Widget>[
              Row(
                children: <Widget>[
                  Text("Your activity starts at:",style:textStyleOrangeSS1(),),
                  SizedBox(width: 2,),
                  Text(
                    data['_startTime'],
                    style: smallAddress(),
              ...
              Row(
                children: <Widget>[
                  Text("Your activity ends at:",style:textStyleOrangeSS1(),),
                  SizedBox(width: 2,),
                  Text(
                    data['_endTime'],
                    style: smallAddress(),
                              ...
                              if(isPriority == true) {
                                _scaffoldKey.currentState.showSnackBar(
                                    SnackBar(
                                      backgroundColor: Colors.blueGrey,
                                      content: Text(
                                          'Activity added to flexible successfully!'),
                                      duration: Duration(seconds: 2),
                                    ));
                                ...
                                _scaffoldKey.currentState.showSnackBar(
                                    SnackBar(
                                      backgroundColor: Colors.blueGrey,
                                      content: Text(
                                          'Removed the flexible activity successfully!'),
                                      duration: Duration(seconds: 2),
                                    ));
                              }
                            }catch(e) {
        ...
        Padding(
          ...
          child: Text("About your activity:", style: prefix0.subBoldTitleUnderline(),),
        ),
        Form(
          key: _formKey,
          child: Container(
