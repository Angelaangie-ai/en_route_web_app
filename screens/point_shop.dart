import 'package:enroute/components/app_theme.dart';

import 'point_card.dart';
import 'point_products_list.dart';
import 'package:enroute/components/point_colors.dart';
import 'package:enroute/components/point_bottom_app_bar.dart';
...
import 'package:enroute/components/point_custom_navigation_rail.dart';
...
class PointShop extends StatelessWidget {
    ...
    return GetBuilder<Controller>(
      ...
      builder: (_) {
        return Scaffold(
          ...
          appBar: AppBar(
            title: Text("EnRoute Online Shop", style:
              TextStyle(
  ...
  Widget _showProducts(BuildContext context) {
    // Header Text
    final String welcomeText = "Welcome Climate Hero, use you hard-earned points here!";
